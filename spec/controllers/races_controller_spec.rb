  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved race as @race" do
        post :create, {:race => invalid_attributes}, valid_session
        expect(assigns(:race)).to be_a_new(Race)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested race" do
        race = Race.create! valid_attributes
        put :update, {:id => race.to_param, :race => new_attributes}, valid_session
        race.reload
    ...
    context "with invalid params" do
      it "assigns the race as @race" do
        race = Race.create! valid_attributes
        put :update, {:id => race.to_param, :race => invalid_attributes}, valid_session
        expect(assigns(:race)).to eq(race)
      end
